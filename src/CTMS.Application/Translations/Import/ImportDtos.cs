...
/// <list type="bullet">
///   <item><see cref="Format"/> — <c>json</c> or <c>flat</c>;</item>
///   <item><see cref="Language"/> — a BCP-47 code that must be enabled for the project;</item>
...
///   <c>Draft</c> (default), <c>InReview</c> or <c>Approved</c>. <c>Published</c> and <c>Archived</c> are rejected;</item>
